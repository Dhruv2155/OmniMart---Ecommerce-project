...
const About = ()=>{
  ...
  const socialBtnStyle = {
    ...
    return (
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Dhruv Bhardwaj</h3>

      <p style={{ color: '#a1a1aa', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '600px', margin: '0 auto 30px auto' }}>
        <strong>Buy products from OmniMart</strong> Welcome to my platform where you can buy anything you want at very reasonable price.
      </p>
